...
class Bank(User):
    ...
    def deposit(self):
        ...
        return f"Your balance is now {self.balance, 2}"
...
def options(user_two):
    print("Thank you for creating your bank acount")
    print("Here are a list of optioons, please choopse the number you want")
    while True:
        ...
        if option_choice == 1:
            ...
            print(user_one_bank.withdrawss())
            ...
            print("Thank you for using PRAV Bank.")
            return False
            break
        else:
